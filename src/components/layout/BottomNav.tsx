...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-20 w-full max-w-[430px] -translate-x-1/2 rounded-t-[2rem] border border-white/70 bg-white/95 px-5 pb-4 pt-3 shadow-[0_-14px_40px_rgb(7_50_71/0.12)] backdrop-blur sm:bottom-4 sm:w-[calc(100%-2rem)] sm:rounded-[2rem] sm:pb-3">
